...
void input_port_core(int port_id)
{
	...
	while(1)
	{
		...
		{
			dest_port = 	
				(tb_config.input_port_3_random_dest_flag ? ((rand() & 0x1)+1) :  
					tb_config.input_port_3_destination_port);
		}
		else if (port_id == 4)
		{
			dest_port = 	
				(tb_config.input_port_4_random_dest_flag ? ((rand() & 0x1)+1) :  
...
void output_port_core(int port_id)
{
	...
	while(1)
	{
		...
		// int input_port = ((packet[0] & 0x1) ? 1 : 2); ///////////////// This part is to understand...........
...
int main(int argc, char* argv[])
{
	...
	/////////////////////////////////////////////////Have to work on destination port here below.............
	tb_config.input_port_3_destination_port = (__3to1 ? 1 : (__3to2 ? 2 : -1));
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////
